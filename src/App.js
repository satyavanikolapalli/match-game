...
class App extends Component {
  ...
  getImagesResults = () => {
    ...
    const filteredImages = imagesList.filter(
      eachImage => eachImage.category === activatedTab,
    )
  ...
  render() {
    ...
    const filteredImages = this.getImagesResults()
    return (
      <>
        <div className="match-game-bg-container">
            ...
            <div className="header-details">
              ...
              <ul className="score-time-container">
                <li className="score-container">
                  <p className="score">
                    Score: <span className="display-score-timer">{score}</span>
                  </p>
                </li>
                <li className="time-container">
                  ...
                  />
                  <p className="display-score-container">{runningTime}</p>
                </li>
              </ul>
            </div>
          </nav>
          {!showResults ? (
            <div className="game-section">
              ...
              />
              <ul className="category-headings">
            ...
            <ResultCard onRestartGame={this.onRestartGame} finalScore={score} />
          )}
        </div>
      </>
    )
